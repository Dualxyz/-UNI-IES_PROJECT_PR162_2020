...
namespace FTN.ESI.SIMES.CIM.CIMAdapter.Importer
{
    ...
    public class PowerTransformerImporter
    {
        ...
        private void ImportConnectivityNodeContainers()
        {
            ...
            {
                foreach (KeyValuePair<string, object> cimConnectivityNodeContainerPair in cimConnectivityNodeContainers)//trazimo objekat
                {
        ...
        private ResourceDescription CreateConnectivityNodeContainerResourceDescription(FTN.ConnectivityNodeContainer cimConnectivityNodeContainer)
        {
            ...
            if (cimConnectivityNodeContainer != null)
            {
                ...
                PowerTransformerConverter.PopulateConnectivityNodeContainerProperties(cimConnectivityNodeContainer, rd, importHelper, report);
            }
            return rd;
        }
        ...
        private void ImportTerminals()
        {
            ...
            if (cimTerminals != null)
            {
                foreach (KeyValuePair<string, object> cimTerminalPair in cimTerminals)
                {
                    ...
                    ResourceDescription rd = CreateTerminalResourceDescription1(cimTerminal);
                    if (rd != null)
                    {
                        delta.AddDeltaOperation(DeltaOpType.Insert, rd, true);
        ...
        private ResourceDescription CreateTerminalResourceDescription1(FTN.Terminal cimTerminal)
        {
            ResourceDescription rd = null;
            if (cimTerminal != null)
            {
